...
export const Employee = ({ employee }: { employee: EmployeeType }) => {
  ...
  return (
    <>
      <div className="employee flex-[1] max-w-[270px] min-w-[270px] w-[270px] border overflow-hidden border-gray-100 shadow-sm rounded-sm relative">
