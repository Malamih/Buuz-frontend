...
import EyeIcon from "@/assets/icons/pixled-eye.svg";
import EyeIconClosed from "@/assets/icons/pixled-eye-closed.svg";
      ...
      >
        <div className="wrapper w-full max-w-[600px] m-auto">
          <h1 className="font-bold mb-4 text-3xl text-center">
            Login To <span className="text-darkPrimary">Malamih</span> Dashboard
          </h1>
