        ...
        <section className="player">
            <div className="container px-0">
                <div className="default w-full">
                    <div className="video relative flex justify-center rounded-tl-[76px] rounded-br-[76px] overflow-hidden">
                        <div className="image w-full">
                            <Image src={"/portfolio/main.png"} width={1000} height={1000} alt="default" className="w-full object-cover" />
                    ...
                    <div className="title px-4 sm:p-0 text-2xl sm:text-4xl my-10 font-bold">
                        <h1>Mirmaz Academy TVC | مرماز تحلها</h1>
                    </div>
                    <div className="profile px-4 sm:p-0 flex gap-4">
                        <Image src={"/portfolio/profile.png"} width={60} height={60} alt="profile" />
