    ...
    <section className="contactForm text-onBackground bg-[#262626] lg:bg-[linear-gradient(to_right,_#262626_50%,_white_50%)]">
      <div className="container flex gap-4 flex-col lg:flex-row p-0">
        ...
        <div className="title lg:w-full min-w-[400px] pt-[100px]">
          <h1 className="font-bold mb-4 text-4xl md:text-6xl italic">
            Let's talk!
          </h1>
          <p className="font-light w-full max-w-[500px] text-2xl md:text-5xl italic">
          ...
          <div className="services">
            ...
            <div className="checkBoxes flex flex-wrap gap-4">
              {servicesCheckBoxes.map((service, i: number) => {
                return (
                  <div
                    className="service cursor-pointer w-full lg:w-[calc(50%-16px)] text-[#848484] text-2xl font-light flex items-center gap-2"
                    key={i}
                  >
                    <div className="input relative min-w-[25px] min-h-[25px] border border-[#848484]">
                      <div
                        className={clsx(
                          "active opacity-0 absolute flex top-0  items-center justify-center left-0 w-full h-full bg-background",
                          {
